...
bool IntersectTri( const Vector3& p0, const Vector3& p1, const Vector3& p2, const Vector3& rayPos, const Vector3& rayDir, float& u, float& v, float& dist );
bool IntersectTri( const XMVECTOR& v0, const XMVECTOR& e1, const XMVECTOR& e2, const XMVECTOR& rayPos, const XMVECTOR& rayDir, float& u, float& v, float& dist );
