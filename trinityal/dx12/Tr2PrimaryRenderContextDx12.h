...
public:
	...
	const std::shared_ptr<ShaderResourceViewDx12>& GetSrvHeapView() const;
	const std::shared_ptr<UnorderedAccessViewDx12>& GetUavHeapView() const;
	ID3D12DescriptorHeap* GetGlobalSamplerHeap() const;
	const std::shared_ptr<SamplerStateDx12>& GetSamplerHeapView() const;
	...
	const std::shared_ptr<ShaderResourceViewDx12>& GetNullSrvDx12( Tr2ShaderRegisterAL::RegisterType type ) const;
	const std::shared_ptr<UnorderedAccessViewDx12>& GetNullUavDx12( Tr2ShaderRegisterAL::RegisterType type ) const;
	const std::shared_ptr<SamplerStateDx12>& GetNullSamplerDx12() const;
