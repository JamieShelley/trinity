...
class NSAMDRWorkflowApplication:
    # Purpose: Implement format duration for NSAMDRWorkflowApplication.
    ...
    # Purpose: Implement schedule progress for NSAMDRWorkflowApplication.
    # Called by: External callers and the owning workflow.
    # Calls: No same-class helper methods.
    ...
    # Purpose: Implement phase eta from step ms for NSAMDRWorkflowApplication.
    # Called by: External callers and the owning workflow.
    # Calls: No same-class helper methods.
    def _phase_eta_from_step_ms(self, item_index: int, item_total: int, step_ms: float) -> float:
    ...
    # Purpose: Implement main for NSAMDRWorkflowApplication.
    # Called by: External callers and the owning workflow.
    # Calls: No same-class helper methods.
    def main(self) -> None:
...
_n_s_a_m_d_r_workflow_application = NSAMDRWorkflowApplication()
_format_duration = _n_s_a_m_d_r_workflow_application._format_duration
_schedule_progress = _n_s_a_m_d_r_workflow_application._schedule_progress
_phase_eta_from_step_ms = _n_s_a_m_d_r_workflow_application._phase_eta_from_step_ms
main = _n_s_a_m_d_r_workflow_application.main
...
class App:
    ...
    # Purpose: Implement load state for App.
    # Called by: __init__
    # Calls: No same-class helper methods.
    ...
    # Purpose: Implement save for App.
    # Called by: _normalize_recovered_process_state, _selected, _set_status, detect
    # Calls: No same-class helper methods.
    def _save(self) -> None:
        self.state_dir.mkdir(parents=True, exist_ok=True)
        self.state_path.write_text(json.dumps(self.state, indent=2) + "\n", encoding="utf-8")

    # Purpose: Implement normalize recovered process state for App.
    # Called by: __init__
    # Calls: _save
    ...
    # Purpose: Implement experiments root for App.
    # Called by: _experiment_ids, _refresh_scope, _training_artifact_paths, _validate_before_launch, detect
    # Calls: No same-class helper methods.
    def _experiments_root(self) -> Path:
        return self.repo / "artifacts/nsamdr/experiments"

    # Purpose: Implement qualified final for App.
    # Called by: _experiment_ids
    # Calls: No same-class helper methods.
    @staticmethod
    ...
    # Purpose: Implement experiment ids for App.
    # Called by: _latest_completed_experiment, _previewable_experiment_ids, _selected, detect
    # Calls: _experiments_root, _qualified_final
    ...
    # Purpose: Implement previewable experiment ids for App.
    # Called by: _preview_choices, _selected, _stage_lock_reason, preview_available_model
    # Calls: _experiment_ids
    def _previewable_experiment_ids(self) -> list[str]:
        return self._experiment_ids(completed_only=True)

    # Purpose: Implement preview choices for App.
    # Called by: _poll, _refresh_preview_selector
    # Calls: _previewable_experiment_ids
    def _preview_choices(self) -> list[str]:
        return list(reversed(self._previewable_experiment_ids()))

    # Purpose: Implement refresh preview selector for App.
    # Called by: _build, _poll, _preview_refresh_tick, detect, preview_available_model
    # Calls: _preview_choices
    ...
    # Purpose: Implement clear form for App.
    # Called by: _selected
    # Calls: No same-class helper methods.
    ...
    # Purpose: Implement value for App.
    # Called by: _args, _training_artifact_paths, _validate_before_launch, preview_available_model
    # Calls: No same-class helper methods.
    ...
    # Purpose: Implement args for App.
    # Called by: _command_line, _process_command
    # Calls: _value
    ...
    # Called by: _command_line, _process_command, preview_available_model
    # Calls: No same-class helper methods.
    ...
    # Purpose: Implement command line for App.
    # Called by: _run, _update_command
    # Calls: _args, _dispatcher_argv
    ...
    # Purpose: Implement update command for App.
    # Called by: _row, _selected
    # Calls: _command_line
    ...
    # Purpose: Implement row for App.
    # Called by: _selected, _training_performance_rows
    # Calls: _update_command
    ...
    # Purpose: Implement label row for App.
    # Called by: _selected
    # Calls: No same-class helper methods.
    ...
    # Purpose: Implement check for App.
    # Called by: _selected
    # Calls: No same-class helper methods.
    ...
    # Purpose: Implement stage lock reason for App.
    # Called by: _selected, _validate_before_launch, detect
    # Calls: _previewable_experiment_ids
    ...
    # Purpose: Implement training performance rows for App.
    # Called by: _selected
    # Calls: _row
    ...
    # Purpose: Implement selected for App.
    # Called by: _build, _run_pending, detect, run_next
    # Calls: _check, _clear_form, _experiment_ids, _label_row, _previewable_experiment_ids, _row, _save, _stage_lock_reason, _training_performance_rows, _update_command
    ...
    # Purpose: Implement build for App.
    # Called by: __init__
    # Calls: _refresh_preview_selector, _selected
    ...
    # Purpose: Implement set status for App.
    # Called by: _poll, _run, stop
    # Calls: _save
    ...
    # Purpose: Implement latest completed experiment for App.
    # Called by: _refresh_scope
    # Calls: _experiment_ids
    def _latest_completed_experiment(self) -> str | None:
        values = self._experiment_ids(completed_only=True)
        return values[-1] if values else None

    # Purpose: Implement refresh scope for App.
    # Called by: detect
    # Calls: _experiments_root, _latest_completed_experiment
    ...
    # Purpose: Implement detect for App.
    # Called by: __init__, _poll
    # Calls: _experiment_ids, _experiments_root, _refresh_preview_selector, _refresh_scope, _save, _selected, _stage_lock_reason
    ...
    # Purpose: Implement poll for App.
    # Called by: __init__
    # Calls: _preview_choices, _refresh_preview_selector, _set_status, detect
    def _poll(self) -> None:
        try:
            while True:
    ...
    # Purpose: Implement preview phase from line for App.
    # Called by: _poll_preview
    # Calls: No same-class helper methods.
    ...
    # Purpose: Implement append preview log for App.
    # Called by: _launch_preview_with_detailed_log, _poll_preview, _show_preview_progress_window
    # Calls: No same-class helper methods.
    ...
    # Purpose: Implement poll preview for App.
    # Called by: __init__
    # Calls: _append_preview_log, _preview_phase_from_line
    def _poll_preview(self) -> None:
        ...
        try:
            ...
            pass
    # Purpose: Implement init for App.
    # Called by: External callers and the owning workflow.
    # Calls: _build, _load_state, _normalize_recovered_process_state, _poll, _poll_preview, detect
    ...
    # Purpose: Implement form content configured for App.
    # Called by: _form_canvas_configured
    # Calls: No same-class helper methods.
    def _form_content_configured(self, _event: tk.Event | None = None) -> None:
        self.form_canvas.configure(scrollregion=self.form_canvas.bbox("all"))

    # Purpose: Implement form canvas configured for App.
    # Called by: External callers and the owning workflow.
    # Calls: _form_content_configured
    ...
    # Purpose: Implement form mousewheel for App.
    # Called by: External callers and the owning workflow.
    # Calls: No same-class helper methods.
    ...
    # Purpose: Implement set initial vertical split for App.
    # Called by: External callers and the owning workflow.
    # Calls: No same-class helper methods.
    ...
    # Purpose: Implement preview selection changed for App.
    # Called by: External callers and the owning workflow.
    # Calls: No same-class helper methods.
    ...
    # Purpose: Implement preview refresh tick for App.
    # Called by: External callers and the owning workflow.
    # Calls: _refresh_preview_selector
    ...
    # Purpose: Implement training artifact paths for App.
    # Called by: _validate_before_launch
    # Calls: _experiments_root, _value
    ...
    # Purpose: Implement validate before launch for App.
    # Called by: _run_pending, run_next, run_selected
    # Calls: _experiments_root, _stage_lock_reason, _training_artifact_paths, _value
    ...
    # Purpose: Implement process command for App.
    # Called by: _run
    # Calls: _args, _dispatcher_argv
    ...
    # Purpose: Implement run for App.
    # Called by: _run_pending, run_next, run_selected
    # Calls: _command_line, _process_command, _set_status
    ...
    # Purpose: Implement run selected for App.
    # Called by: External callers and the owning workflow.
    # Calls: _run, _validate_before_launch
    ...
    # Purpose: Implement run next for App.
    # Called by: External callers and the owning workflow.
    # Calls: _run, _selected, _validate_before_launch
    ...
    # Purpose: Implement run pending for App.
    # Called by: run_remaining
    # Calls: _run, _selected, _validate_before_launch
    ...
    # Purpose: Implement run remaining for App.
    # Called by: External callers and the owning workflow.
    # Calls: _run_pending
    ...
    # Purpose: Implement worker for App.
    # Called by: External callers and the owning workflow.
    # Calls: No same-class helper methods.
    ...
    # Purpose: Implement stop for App.
    # Called by: External callers and the owning workflow.
    # Calls: _set_status
    def stop(self) -> None:
    ...
    # Purpose: Implement show preview progress window for App.
    # Called by: _launch_preview_with_detailed_log
    # Calls: _append_preview_log
    ...
    # Purpose: Implement preview worker for App.
    # Called by: External callers and the owning workflow.
    # Calls: No same-class helper methods.
    ...
    # Purpose: Implement launch preview with detailed log for App.
    # Called by: preview_available_model
    # Calls: _append_preview_log, _show_preview_progress_window
    ...
    # Purpose: Implement preview available model for App.
    # Called by: External callers and the owning workflow.
    # Calls: _dispatcher_argv, _launch_preview_with_detailed_log, _previewable_experiment_ids, _refresh_preview_selector, _value
