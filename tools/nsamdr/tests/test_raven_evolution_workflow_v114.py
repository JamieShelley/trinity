...
def test_quick_search_is_bounded() -> None:
...
def test_structural_failure_can_recover_but_software_cannot() -> None:
    text = TRAIN.read_text(encoding="utf-8")
...
def test_readme_references_evolution_diagram() -> None:
