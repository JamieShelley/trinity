"""Contracts for the V11.2 local-boundary production override."""
...
class TestLocalBoundaryV112Contract:
    # Purpose: Implement test current v11 is patched not replaced for TestLocalBoundaryV112Contract.
    ...
    # Purpose: Implement test structural authority is auditable wrapper for TestLocalBoundaryV112Contract.
    # Called by: External callers and the owning workflow.
    # Calls: No same-class helper methods.
    ...
    # Purpose: Implement test production structure is called through forward not query for TestLocalBoundaryV112Contract.
    # Called by: External callers and the owning workflow.
    # Calls: No same-class helper methods.
    ...
    # Purpose: Implement test no duplicate module aliases in contract source for TestLocalBoundaryV112Contract.
    # Called by: External callers and the owning workflow.
    # Calls: No same-class helper methods.
    ...
    # Purpose: Implement test complete production graph is preserved for TestLocalBoundaryV112Contract.
    # Called by: External callers and the owning workflow.
    # Calls: No same-class helper methods.
    ...
    # Purpose: Implement test local losses are existing physical geometry losses for TestLocalBoundaryV112Contract.
    # Called by: External callers and the owning workflow.
    # Calls: No same-class helper methods.
    ...
    # Purpose: Implement test quick uses validator legal minimum for retired slot for TestLocalBoundaryV112Contract.
    # Called by: External callers and the owning workflow.
    # Calls: No same-class helper methods.
    ...
    # Purpose: Implement test pass driven plan never invokes retired sdf proof for TestLocalBoundaryV112Contract.
    # Called by: External callers and the owning workflow.
    # Calls: No same-class helper methods.
    ...
    # Purpose: Implement test local promotion advances resume cursor past retired slot for TestLocalBoundaryV112Contract.
    # Called by: External callers and the owning workflow.
    # Calls: No same-class helper methods.
    ...
    # Purpose: Implement test local gate does not consume primitive classifier metrics for TestLocalBoundaryV112Contract.
    # Called by: External callers and the owning workflow.
    # Calls: No same-class helper methods.
    ...
    # Purpose: Implement test package init installs one local model contract for TestLocalBoundaryV112Contract.
    # Called by: External callers and the owning workflow.
    # Calls: No same-class helper methods.
    ...
    # Purpose: Implement test runtime forward hook sees production structure for TestLocalBoundaryV112Contract.
    # Called by: External callers and the owning workflow.
    # Calls: No same-class helper methods.
