...
class TestNsamdrOopReadabilityContract:
    def _evolution_files(self) -> list[Path]:
    ...
    def test_every_function_has_structured_docstring(self) -> None:
        ...
        """
        for path in self._evolution_files():
    ...
    def test_call_dependency_order(self) -> None:
    ...
    def test_legacy_evolutionary_recovery_api_is_preserved(self) -> None:
...
_test_nsamdr_oop_readability_contract = TestNsamdrOopReadabilityContract()
_evolution_files = _test_nsamdr_oop_readability_contract._evolution_files
