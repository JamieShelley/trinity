...
class B1AParametricBootstrap:
    # Purpose: Implement is b1a training dataset for B1AParametricBootstrap.
    # Called by: _balanced_b1a_getitem
    # Calls: No same-class helper methods.
    def _is_b1a_training_dataset(self, instance: Any) -> bool:
        return (
    ...
    # Purpose: Implement balanced b1a getitem for B1AParametricBootstrap.
    # Called by: External callers and the owning workflow.
    # Calls: _is_b1a_training_dataset
    def _balanced_b1a_getitem(self, instance: Any, index: int) -> dict[str, Any]:
        """Return one deterministic complete-teacher primitive, balanced by class."""
        if not self._is_b1a_training_dataset(instance):
    ...
    # Purpose: Implement compute losses b1a for B1AParametricBootstrap.
    # Called by: External callers and the owning workflow.
    # Calls: No same-class helper methods.
    ...
    # Purpose: Implement install b1a parametric bootstrap for B1AParametricBootstrap.
    # Called by: External callers and the owning workflow.
    # Calls: No same-class helper methods.
    def install_b1a_parametric_bootstrap(self) -> None:
...
_b1_a_parametric_bootstrap = B1AParametricBootstrap()
_is_b1a_training_dataset = _b1_a_parametric_bootstrap._is_b1a_training_dataset
_balanced_b1a_getitem = _b1_a_parametric_bootstrap._balanced_b1a_getitem
_compute_losses_b1a = _b1_a_parametric_bootstrap._compute_losses_b1a
install_b1a_parametric_bootstrap = _b1_a_parametric_bootstrap.install_b1a_parametric_bootstrap
