...
class TestNsamdrV9Checkpoint:
    # Purpose: Implement main for TestNsamdrV9Checkpoint.
...
_test_nsamdr_v9_checkpoint = TestNsamdrV9Checkpoint()
main = _test_nsamdr_v9_checkpoint.main
