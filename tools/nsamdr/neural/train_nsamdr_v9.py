...
class NSAMDRTrainingApplication:
    # Purpose: Implement semantic maps from rgb for NSAMDRTrainingApplication.
    # Called by: External callers and the owning workflow.
    # Calls: No same-class helper methods.
    def _semantic_maps_from_rgb(self, rgb: np.ndarray) -> np.ndarray:
    ...
    # Purpose: Implement main for NSAMDRTrainingApplication.
    # Called by: External callers and the owning workflow.
    # Calls: No same-class helper methods.
...
_n_s_a_m_d_r_training_application = NSAMDRTrainingApplication()
_semantic_maps_from_rgb = _n_s_a_m_d_r_training_application._semantic_maps_from_rgb
main = _n_s_a_m_d_r_training_application.main
