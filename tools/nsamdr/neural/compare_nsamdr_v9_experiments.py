...
def _card(repo_root: Path, experiment_id: str) -> tuple[str, dict]:
    ...
    <section class=\"card\">
      ...
      <div class=\"viewport\"><img class=\"sync-image\" src=\"{html.escape(_file_uri(image))}\"></div>
...
def main() -> int:
    ...
    for experiment_id in ids:
        card, record = _card(root, experiment_id)
        cards.append(card)
